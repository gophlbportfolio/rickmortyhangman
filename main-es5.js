(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CharacterComponent = /** @class */ (function () {
                function CharacterComponent(apiService, store) {
                ...
                CharacterComponent.prototype.ngOnInit = function () {
                    ...
                    this.store.lastLetter$.subscribe(function (_) { return _this.onKey(_); });
                    this.store.gameOver$.subscribe(function (_) { return _this.onGameOver(_); });
                    this.store.nextMatch$.subscribe(function (_) { return _this.onNextMatch(_); });
                };
                CharacterComponent.prototype.getRandomCharacter = function () {
                    var _this = this;
                    var newId = this.getRandomId();
                    this.apiService.getRandom(newId).subscribe(function (_) {
                        var character = _.data.character;
                        ...
                        _this.name = character.name.toLowerCase();
                        character.name = _this.name.replace(/[a-z]/g, '_');
                        _this.character = character;
                    });
                };
                CharacterComponent.prototype.onKey = function (letter) {
                    if (!!this.character) {
                        var letterFound = this.name.indexOf(letter) !== -1;
                        var newName = this.character.name;
                        if (letterFound) {
                ...
                CharacterComponent.prototype.onGameOver = function (gameOver) {
                    if (gameOver) {
                        this.character.name = this.name;
                    }
                };
                CharacterComponent.prototype.onNextMatch = function (nextMatch) {
                    if (nextMatch) {
                        this.getRandomCharacter();
                    }
                };
                CharacterComponent.prototype.toggleInfo = function () {
                    this.isInfoVisible = !this.isInfoVisible;
                };
                CharacterComponent.prototype.getRandomId = function () {
                    var newIdFound = false;
                    var newId;
                    while (!newIdFound) {
                        newId = this.randomize();
                        newIdFound = this.randomizedIds.findIndex(function (_) { return _ === newId; }) === -1;
                        if (newIdFound) {
                ...
                CharacterComponent.prototype.randomize = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FailStatusComponent = /** @class */ (function () {
                function FailStatusComponent(store) {
                    this.store = store;
                    this.maximumFails = 9;
                    this.statuses = new Array(this.maximumFails);
                }
                FailStatusComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.store.fails$.subscribe(function (_) {
                        if (_ < _this.maximumFails) {
                            _this.statuses[_ - 1] = true;
                        }
                        else if (_ === _this.maximumFails) {
                            _this.statuses[_ - 1] = true;
                            _this.store.gameOver();
                        }
                        else {
                            _this.store.gameOver();
                        }
                ...
                FailStatusComponent.prototype.onNextMatch = function (nextMatch) {
                    if (nextMatch) {
                        this.statuses = new Array(this.maximumFails);
                    }
                };
                return FailStatusComponent;
            }());
            FailStatusComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KeyComponent = /** @class */ (function () {
                ...
                KeyComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.store.gameOver$.subscribe(function (_) { return _this.onGameOver(_); });
                    this.store.win$.subscribe(function (_) { return _this.onWin(_); });
                    this.store.nextMatch$.subscribe(function (_) { return _this.onNextMatch(_); });
                };
                KeyComponent.prototype.onClick = function () {
                    if (this.isClickable) {
                        this.store.lastLetter = this.letter;
                        this.isClickable = false;
                    }
                };
                KeyComponent.prototype.onGameOver = function (gameOver) {
                    if (gameOver) {
                        this.isClickable = false;
                    }
                };
                KeyComponent.prototype.onWin = function (win) {
                    if (win) {
                        this.isClickable = false;
                    }
                };
                KeyComponent.prototype.onNextMatch = function (nextMatch) {
                    if (nextMatch) {
                        this.isClickable = true;
                    }
                };
            ...
            KeyComponent.ctorParameters = function () { return [
                { type: _services_store_service__WEBPACK_IMPORTED_MODULE_2__["StoreService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ScoreboardComponent = /** @class */ (function () {
                ...
                ScoreboardComponent.prototype.onGameOver = function (gameOver) {
                    if (gameOver) {
                        this.lose++;
                    }
                };
                ScoreboardComponent.prototype.onWin = function (win) {
                    if (win) {
                        this.win++;
                    }
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ApiService = /** @class */ (function () {
                ...
                ApiService.prototype.getRandom = function (id) {
                    return this.httpClient.get(this.buildQuery(id));
                };
                ApiService.prototype.buildQuery = function (id) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var StoreService = /** @class */ (function () {
                ...
                Object.defineProperty(StoreService.prototype, "lastLetter", {
                    get: function () {
                        return this._lastLetter$.getValue();
                    },
                    set: function (lastLetter) {
                        this._lastLetter$.next(lastLetter);
                    },
                    enumerable: true,
                    configurable: true
                });
                StoreService.prototype.newFailure = function () {
                    this._fails$.next(this._fails$.getValue() + 1);
                };
                StoreService.prototype.gameOver = function () {
                    this._gameOver$.next(true);
                };
                StoreService.prototype.win = function () {
                    this._win$.next(true);
                };
                StoreService.prototype.nextMatch = function () {
                    this._fails$.next(0);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SplashScreenComponent = /** @class */ (function () {
                function SplashScreenComponent(store) {
                    this.store = store;
                }
                ...
                SplashScreenComponent.prototype.onClick = function () {
                    this.lose = false;
                    this.win = false;
                    this.isVisible = false;
                    this.store.nextMatch();
                };
                SplashScreenComponent.prototype.onGameOver = function (gameOver) {
                    if (gameOver) {
                        this.lose = true;
                        this.isVisible = true;
                    }
                };
                SplashScreenComponent.prototype.onWin = function (win) {
                    if (win) {
                        this.win = true;
                        this.isVisible = true;
                    }
